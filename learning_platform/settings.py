...
SECRET_KEY = 'django-insecure-b_7(%oku(1e#0=dx-*9x7s)yljr32+c2(-7l8cup#$tl_hy0vz'
...
INSTALLED_APPS = [
    ...
    'accounts.apps.AccountsConfig',  # Full path
    'courses.apps.CoursesConfig',    # Full path
    'progress.apps.ProgressConfig',  # Full path
    'paypal.standard.ipn',
]
